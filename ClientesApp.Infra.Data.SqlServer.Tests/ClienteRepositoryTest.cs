...
namespace ClientesApp.Infra.Data.SqlServer.Tests
{
    public class ClienteRepositoryTest
    {
        ...
        public ClienteRepositoryTest()
        {
            ...
            //configurar o Mock de testes para o DataContext em memória
        ...
        public async Task AddAsync_ShouldAddCliente()
        {
            ...
            var clienteCadastrado = await _clienteRepository.GetByIdAsync(Guid.NewGuid());

            //verificação se o cliente foi cadastrado (asserções de teste)
